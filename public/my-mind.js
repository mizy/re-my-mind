...
/* harmony default export */ __webpack_exports__["default"] = (MM.Layout);
...
MM.Layout.Graph._drawHorizontalConnectors = function (item, side, children) {
  ...
  ctx.moveTo(x1, y1);
  ctx.lineTo(xx, y1);
  ctx.lineTo(x + sideVal * (10 - 1), y1);
  ctx.arcTo(x, y1, x, y1 + 10, 10);
  ctx.lineTo(x, y2 - 10 + 1);
  ctx.arcTo(x, y2, x + sideVal * 10, y2, 10);
  ctx.moveTo(x + sideVal * (10 - 1), y2);
  ctx.lineTo(x2, y2);
...
MM.Layout.Map._drawRootConnectors = function (item, side, children) {
  ...
  for (var i = 0; i < children.length; i++) {
    ...
    ctx.quadraticCurveTo((x2 + x1) / 2, y2, x2, y2); // ctx.quadraticCurveTo((x2+x1)/2, y2, x2, y2);
...
/* harmony default export */ __webpack_exports__["default"] = (MM.Layout.Map);
