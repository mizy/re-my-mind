...
var getAllActions = function getAllActions(remind) {
  ...
  Action.SetIcon = function (item, icon, type) {
    ...
    if (icon) {
      this.icon = Actions_objectSpread(Actions_objectSpread({}, item.data.icon), {}, (0,defineProperty/* default */.Z)({}, type, icon));
    } else {
      this.icon = Actions_objectSpread({}, item.data.icon);
...
var Menu = /*#__PURE__*/function () {
  function Menu(_remind) {
    ...
    this.onShow = function (e) {
      e.preventDefault();
      _this.nowEvent = e; // const item = this.remind.page.getByEvent(e);
      // if(item){
    ...
    this.onClick = function (e) {
      ...
      command = _this.remind.command.execute(command, _this.remind.page.current, _this.nowEvent);
